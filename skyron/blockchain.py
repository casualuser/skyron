import skyron.proof
import skyron.config as cfg
from skyron.book import Book
from skyron.block import Block
...
class BlockChain:
    ...
    def init_chain(self):
        ...
        genesis_proof = skyron.proof.find_proof(genesis_block)
    ...
    def valid(self):
        ...
        while index < len(self):
            ...
            if not skyron.proof.valid_proof(curr_block):
                return False
